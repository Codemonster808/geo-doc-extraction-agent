...
and compares to the embedded ground truth (from src/ingestion/data_gen.py), field
...
from models.extraction_agent import extract_with_confidence_gate  # noqa: E402
...
def main() -> None:
    ...
    summary = {
        ...
        "avg_attempts": round(sum(r["attempts"] for r in results) / n_reports, 2)
        if n_reports
        else 0,
        "results": results,
    }
