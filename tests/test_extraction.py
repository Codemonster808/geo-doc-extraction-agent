...
from extraction_agent import ExtractedRecord  # noqa: E402
...
def test_coordinate_outside_survey_region_rejected():
    ...
    with pytest.raises(ValidationError, match="outside survey region bounds"):
        ExtractedRecord(**{**VALID, "lat": 40.7, "lon": -74.0})  # New York, not the synthetic survey region


def test_extraction_json_parsing_from_noisy_llm_output():
    from extraction_agent import _extract_json
